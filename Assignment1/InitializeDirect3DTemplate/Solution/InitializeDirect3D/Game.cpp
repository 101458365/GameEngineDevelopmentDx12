...
/**
 * @brief Handles real-time keyboard input.
 *
 * WASD moves the camera.
 * Arrow keys set the player aircraft velocity so it moves in the XZ plane.
 *
...
void Game::OnKeyboardInput(const GameTimer& gt)
{
    ...
    // Player aircraft movement via arrow keys.
    mWorld.handlePlayerInput(gt);
}
